...
const transformFile = Bun.file('./OSTN15_NTv2_OSGBtoETRS.gsb');
const transformData = await transformFile.arrayBuffer();

// Configure proj4 with EPSG definitions
proj4.nadgrid('OSTN15_NTv2_OSGBtoETRS', transformData);
